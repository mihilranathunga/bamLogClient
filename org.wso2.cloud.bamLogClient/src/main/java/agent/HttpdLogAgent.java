...
public class HttpdLogAgent {
    private static final String HTTPD_LOG_STREAM = "org.wso2.sample.mihil.logs";
    ...
    private static void setupBamAgent() throws SocketException, UnknownHostException, MalformedURLException, AgentException, AuthenticationException, TransportException {
    	 
    	System.out.println("Starting BAM HttpLog Agent");
    	
         
         String currentDir = System.getProperty("user.dir"); 
         System.setProperty("javax.net.ssl.trustStore", currentDir + "/resources/client-truststore.jks");
    ...
    public void createStreams() throws AgentException, StreamDefinitionException, MalformedStreamDefinitionException, DifferentStreamDefinitionAlreadyDefinedException, FileNotFoundException{
